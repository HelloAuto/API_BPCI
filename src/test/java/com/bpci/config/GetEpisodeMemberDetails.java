...
public class GetEpisodeMemberDetails extends TestBase{
	public ArrayList<HashMap<String, String>> parseResultSetObj(ResultSet rs ){
		...
		try {
			...
			while (rs.next()) {
				...
				rsSet.put(mData.getColumnName(8), rs.getString(8));
				rsSet.put(mData.getColumnName(9), rs.getString(9));
				rsSet.put(mData.getColumnName(10), rs.getString(10));
				rsSet.put(mData.getColumnName(11), rs.getString(11));
